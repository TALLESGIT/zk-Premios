...
const FormularioCadastro = ({ numeroSelecionado }: { numeroSelecionado: number | null }) => {
  ...
  const { addParticipante, isNumeroDisponivel, jaFezCadastro, limparSelecao } = useSorteio();
        ...
        <CardContent className="pt-4">
          {jaFezCadastro ? (
            <div className="text-center p-6">
              ...
              <p className="text-lg font-semibold mb-3 text-brasil-blue">Cadastro já realizado</p>
              <div className="bg-brasil-yellow/30 p-4 rounded-lg shadow-md border border-brasil-yellow mb-6">
                <p className="text-gray-800 text-base mb-2">
                  Cada participante pode escolher apenas um número para o sorteio.
                </p>
                <p className="text-gray-700 text-sm font-medium">
                  Para ter mais chance, clique no banner abaixo e, ao adquirir no mínimo <span className="font-bold">7 reais</span> em bilhetes, você terá direito a mais <span className="font-bold">5 números!</span>
                </p>
              </div>
      ...
      <Dialog open={openConfirm} onOpenChange={setOpenConfirm}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Você confirma que esse número é WhatsApp?
            </DialogDescription>
          </DialogHeader>
